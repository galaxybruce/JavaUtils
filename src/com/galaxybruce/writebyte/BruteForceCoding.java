 ...
 * @author bruce.zhang
 * @description  socket通信协议编码和解码
 *
 * byte[] message = ...
 * ChannelFuture channelFuture = channel.writeAndFlush(new String(finalMessage));
 *
 * <p>
...
public class BruteForceCoding {
	...
	private final static byte byteVal = 101; // one hundred and one
	private final static short shortVal = 10001; // ten thousand and one
	private final static int intVal = 100000001; // one hundred million and one
	private final static long longVal = 1000000000001L;// one trillion and one
